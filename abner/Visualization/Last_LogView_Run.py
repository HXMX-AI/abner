...
def    Save_Last_LogView_Run(p_data, p_tmpl):
    ...
    if p_data.is_file(): print('\n',str(p_data) ,'exists')
    if p_tmpl.is_file(): print(str(p_tmpl), 'exists')
...
if __name__ == "__main__":
    ...
    if False:
        p_data = Path("C:\\Users\\ridva\\OneDrive\\Documents\\WELLS\\Groningen\\Debug\\Remove_LinSeg_1W\\fuck.pck")
        p_tmpl = Path("C:\\Users\\ridva\\OneDrive\\Documents\\WELLS\\Groningen\\Visuals\\LogView_zart.xlsx")

    if False:
        p_tmpl = Path("C:\\Users\\ridva\\OneDrive\\Documents\\WELLS\\Groningen\\Debug\\Remove_LinSeg_1W\\fuck.pck")
        p_data = Path("C:\\Users\\ridva\\OneDrive\\Documents\\WELLS\\Groningen\\Visuals\\LogView_zart.xlsx")

    p_data     = Path("C:/Users/ridva/OneDrive/Documents/WELLS/ND_152N_101W_20241004_LAS_V2/33053026330000-AIG.pck")
    p_tmpl     = Path('C:/Users/ridva/OneDrive/Documents/WELLS/ND_152N_101W_20241004_LAS_V2/Visuals/Log_Template_Separate_Resistivity.xlsx')

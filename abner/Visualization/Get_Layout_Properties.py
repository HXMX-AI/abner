...
def Get_Layout_Properties(inputs):
    ...
    # SET Track lengths ...................................................
    tr_len          = [None] * num_tracks
    logs_per_track  = [None] * num_tracks
    sum_tr_len      = 0
    for n in range(num_tracks):
        cond              = template.trNum == n
        temp              = template.loc[cond,'trLen']
        tr_len[n]         = temp.max()
        logs_per_track[n] = len(temp)
    ...
    df_coords         = pd.DataFrame(columns=['xLeft', 'yBot', 'xLen', 'yLen'], index=range(num_tracks))
    ...
    # SET props_logs ..................................................................
    cols             = ['trNum','xL','xR','color','style', 'width','inHdr','shdTo','shdClr','rot']

...
for n in [0, 2]:
    ...
    entry_idx[-1].grid(row=n + 1, column=1, sticky=tk.NSEW, pady=5)
...
# FRAME 1 ==============================================================================================================
frame1 = tk.Frame(root, width=300, height=300, bg="yellow", relief=tk.RAISED)
frame1.grid(row=5, column=0, columnspan=2, padx=40, pady=30, sticky=tk.W)
...
listbox1 = tk.Listbox(frame1, yscrollcommand=scrollbar1.set, width=50, height=18)

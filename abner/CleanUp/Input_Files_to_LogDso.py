...
def Input_Files_to_LogDso(PRJ, pars_input):
    ...
    if files_csv is None or files_las is None:
        raise ValueError("No csv or las files found")
    ...
    for path_file in files_csv:
        ...
        if dso is None:
            raise ValueError(f"Error creating LogDataSet from {path_file}")
